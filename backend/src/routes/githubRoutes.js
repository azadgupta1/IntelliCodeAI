...
router.get("/errors/:owner/:repo", authenticate, getRepoErrors);


router.put("/:owner/:repo/sync", authenticate, syncRepoMetadata);



router.get('/:owner/:repo/settings', authenticate, getRepoSettings);



router.delete("/:owner/:repoName", authenticate, deleteGithubRepo);
