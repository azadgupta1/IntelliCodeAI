...
//       {errors.map((err, idx) => (
//         <div key={idx} className="border border-gray-200 rounded-md p-4 bg-white shadow-md w-full max-w-3xl">
//           {/* Header */}
...
// // Utility to map severity to label and colors
// const getSeverityDetails = (severity) => {
//   switch (severity) {
//     case "high":
//       return { label: "CRITICAL", borderColor: "border-t-red-500", textColor: "text-red-600" };
//     case "medium":
//       return { label: "MEDIUM", borderColor: "border-t-orange-400", textColor: "text-orange-500" };
//     case "low":
//       return { label: "LOW", borderColor: "border-t-yellow-400", textColor: "text-yellow-500" };
//     default:
//       return { label: "UNKNOWN", borderColor: "border-t-gray-400", textColor: "text-gray-500" };
//   }
// };
...
//     <div className="space-y-6">
//       {errors.map((err, idx) => {
//         const { label, borderColor, textColor } = getSeverityDetails(err.severity);
