...
//         <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2025 <a href="https://flowbite.com/">IntelliCodeAI™</a>. All Rights Reserved.
//         </span>
    ...
    <footer className="bg-black text-white">
      <div className="mx-auto max-w-7xl px-6 py-20">
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-bold">IntelliCodeAI</h3>
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-gray-400">
              IntelliCodeAI is an AI-powered code review platform that helps
              developers write cleaner, safer, and more maintainable code
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-gray-400">
              <li className="hover:text-white transition">AI Code Review</li>
              <li className="hover:text-white transition">Bug Detection</li>
              <li className="hover:text-white transition">Security Analysis</li>
              <li className="hover:text-white transition">Code Quality Score</li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-gray-400">
              ...
              <li className="hover:text-white transition">Project Analysis</li>
              <li className="hover:text-white transition">Pull Request Review</li>
              <li className="hover:text-white transition">Reports & Insights</li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-gray-400">
              ...
              <li className="hover:text-white transition">Best Practices</li>
        ...
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          <p className="text-sm text-gray-400">
            © {new Date().getFullYear()} IntelliCodeAI. All rights reserved.
          </p>
